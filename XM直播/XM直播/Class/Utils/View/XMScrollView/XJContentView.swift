...
class XJContentView: UIView {
    ...
    fileprivate lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(UICollectionViewCell.self, forCellWithReuseIdentifier: NSStringFromClass(XJContentView.self))
...
extension XJContentView : UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        // 1.获取Cell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: NSStringFromClass(XJContentView.self), for: indexPath)
