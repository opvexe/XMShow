    ...
    if ([self.userGigtInfos objectForKey:userID]) {
        ...
        if ([userID integerValue] % 2) {
            ...
            if (op.model.giftCount != 0) {
                op.presentView.frame  = CGRectMake(-self.parentView.frame.size.width / 2, 200, self.parentView.frame.size.width / 2, 40);
            ...
            if (op.model.giftCount != 0) {
                op.presentView.frame  = CGRectMake(-self.parentView.frame.size.width / 2, 150, self.parentView.frame.size.width / 2, 40);
                op.presentView.originFrame = op.presentView.frame;
