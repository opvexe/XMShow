//
//  XM_GiftFlowLayout.swift
//  XM直播
//
//  Created by GDBank on 2017/8/28.
//  Copyright © 2017年 com.GDBank.Company. All rights reserved.
//

import UIKit

class XM_GiftFlowLayout: UICollectionViewFlowLayout {
    
    fileprivate lazy var AttrsM : [UICollectionViewLayoutAttributes] = [UICollectionViewLayoutAttributes]()
    var cols : Int = 4
    var rows : Int = 2
